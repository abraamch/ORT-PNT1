...
namespace _2022_2C_I__HistoriasClinicas_.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PacienteId,ObraSocial,nombreDeUsuario,email,FechaAlta,password,apellido,dni,telefono,direccion")] Paciente paciente)
        {
